...
import { IconSuccess, IconError, ICON_SM, ICON_COLOR } from "@/components/ui/icons";
import {
...
export function WebhookClient({
  ...
  const inputCls = "w-full rounded-lg border border-zinc-200 px-3 py-2 text-base focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 sm:text-sm";
