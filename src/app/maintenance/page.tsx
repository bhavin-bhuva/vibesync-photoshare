...
export default async function MaintenancePage() {
  const appName = await getSetting(SETTING_KEYS.APP_NAME);
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-zinc-50 px-4 text-center">
      <div className="max-w-md">
        ...
        <h1 className="text-2xl font-bold text-zinc-900">{appName} is under maintenance</h1>
        <p className="mt-3 text-sm leading-relaxed text-zinc-500">
          We&apos;re making some improvements. We&apos;ll be back shortly.
          Please check back in a little while.
        </p>

        <div className="mt-8 inline-flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-4 py-2 text-sm font-medium text-amber-700">
